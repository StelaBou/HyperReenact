...
from libs.models.encoders.helpers import get_blocks, bottleneck_IR, bottleneck_IR_SE, _upsample_add
from libs.models.gan.StyleGAN2.model import EqualLinear, ScaledLeakyReLU, EqualConv2d
...
class Encoder4Editing(Module):
    def __init__(self, num_layers, mode='ir', image_resolution = 256):
        ...
        self.styles = nn.ModuleList()
        log_size = int(math.log(image_resolution, 2))
        self.style_count = 2 * log_size - 2
        self.coarse_ind = 3
        self.middle_ind = 7
